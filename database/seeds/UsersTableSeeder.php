...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //DB::table('users')->truncate();
         $admin = factory(myblog\Models\User::class)->create([
        ...
        $editor = factory(myblog\Models\User::class)->create([
        ...
        $user = factory(myblog\Models\User::class)->create([
